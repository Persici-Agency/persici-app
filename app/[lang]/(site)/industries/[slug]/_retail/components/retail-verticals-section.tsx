...
import type { RetailVerticalItem } from '../data/retail.data';
...
interface RetailVerticalsSectionProps {
...
const verticalIconMap: Record<string, React.ElementType> = {
  'department-stores': TbBuildingStore,
  'grocery-hypermarkets': TbShoppingCart,
  'luxury-specialty': TbDiamond,
  'b2b-distribution': TbTruck,
};

export function RetailVerticalsSection({
  verticals,
  title,
  subtitle,
  lang,
}: RetailVerticalsSectionProps) {
  const isRtl = lang === 'ar';
