...
import type { TechStackPod } from '../data/consumer-products.data';
import { TechInfrastructureCard } from '@shared';
import { sectionContainer } from '@shared/constants';
import { FadeUp } from '@shared';

interface ConsumerProductsTechStackSectionProps {
  pods: TechStackPod[];
  title: string;
  subtitle: string;
  lang: string;
...
export function ConsumerProductsTechStackSection({
  pods,
  title,
  subtitle,
  lang,
}: ConsumerProductsTechStackSectionProps) {
  const isRtl = lang === 'ar';
