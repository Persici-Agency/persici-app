...
import type { ConsumerProductsOfferingItem } from '../data/consumer-products.data';
import { CapabilityCard } from '@shared';
import { sectionContainer } from '@shared/constants';
import { FadeUp } from '@shared';

interface ConsumerProductsOfferingsGridProps {
...
export function ConsumerProductsOfferingsGrid({
  offerings,
  title,
  subtitle,
  lang,
}: ConsumerProductsOfferingsGridProps) {
  const isRtl = lang === 'ar';
