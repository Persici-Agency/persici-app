...
import type { ConsumerProductsVerticalItem } from '../data/consumer-products.data';
...
interface ConsumerProductsVerticalsSectionProps {
...
const verticalIconMap: Record<string, React.ElementType> = {
  'luxury-goods': TbDiamond,
  'beauty-personal-care': TbSparkles,
  'food-beverage': TbCoffee,
  'fashion-apparel': TbShirt,
};

export function ConsumerProductsVerticalsSection({
  verticals,
  title,
  subtitle,
  lang,
}: ConsumerProductsVerticalsSectionProps) {
  const isRtl = lang === 'ar';
      ...
      <div className={sectionContainer}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {verticals.map((vert, idx) => {
            ...
            const IconComponent = verticalIconMap[vert.id] || TbShoppingBag;
