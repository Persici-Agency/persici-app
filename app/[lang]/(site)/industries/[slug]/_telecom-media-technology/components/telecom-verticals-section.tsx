...
import type { TelecomVerticalItem } from '../data/telecom-media-technology.data';
...
interface TelecomVerticalsSectionProps {
...
const verticalIconMap: Record<string, React.ElementType> = {
  'telecom-networks': TbBroadcast,
  'media-entertainment': TbDeviceTv,
  'consumer-tech': TbCpu,
  'edge-satellite': TbSatellite,
};

export function TelecomVerticalsSection({
  verticals,
  title,
  subtitle,
  lang,
}: TelecomVerticalsSectionProps) {
  const isRtl = lang === 'ar';
      ...
      <div className={sectionContainer}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {verticals.map((vert, idx) => {
            ...
            const IconComponent = verticalIconMap[vert.id] || TbServer2;
