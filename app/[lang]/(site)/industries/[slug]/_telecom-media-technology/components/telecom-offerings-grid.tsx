...
import type { TelecomOfferingItem } from '../data/telecom-media-technology.data';
import { CapabilityCard } from '@shared';
import { sectionContainer } from '@shared/constants';
import { FadeUp } from '@shared';

interface TelecomOfferingsGridProps {
...
export function TelecomOfferingsGrid({
  offerings,
  title,
  subtitle,
  lang,
}: TelecomOfferingsGridProps) {
  const isRtl = lang === 'ar';
