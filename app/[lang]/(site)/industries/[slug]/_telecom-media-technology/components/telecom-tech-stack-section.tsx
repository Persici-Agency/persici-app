...
import type { TechStackPod } from '../data/telecom-media-technology.data';
import { TechInfrastructureCard } from '@shared';
import { sectionContainer } from '@shared/constants';
import { FadeUp } from '@shared';

interface TelecomTechStackSectionProps {
  pods: TechStackPod[];
  title: string;
  subtitle: string;
  lang: string;
...
export function TelecomTechStackSection({
  pods,
  title,
  subtitle,
  lang,
}: TelecomTechStackSectionProps) {
  const isRtl = lang === 'ar';
