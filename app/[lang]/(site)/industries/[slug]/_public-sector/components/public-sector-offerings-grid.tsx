...
import type { PublicSectorOfferingItem } from '../data/public-sector.data';
import { CapabilityCard } from '@shared';
import { sectionContainer } from '@shared/constants';
import { FadeUp } from '@shared';

interface PublicSectorOfferingsGridProps {
...
export function PublicSectorOfferingsGrid({
  offerings,
  title,
  subtitle,
  lang,
}: PublicSectorOfferingsGridProps) {
  const isRtl = lang === 'ar';
