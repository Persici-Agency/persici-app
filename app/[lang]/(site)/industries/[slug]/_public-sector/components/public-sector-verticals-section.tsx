...
import type { PublicSectorVerticalItem } from '../data/public-sector.data';
...
interface PublicSectorVerticalsSectionProps {
...
const verticalIconMap: Record<string, React.ElementType> = {
  'federal-agencies': TbBuildingBank,
  'smart-cities': TbSmartHome,
  'public-safety': TbShieldCheck,
  'judicial-services': TbScale,
};

export function PublicSectorVerticalsSection({
  verticals,
  title,
  subtitle,
  lang,
}: PublicSectorVerticalsSectionProps) {
  const isRtl = lang === 'ar';
      ...
      <div className={sectionContainer}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {verticals.map((vert, idx) => {
            ...
            const IconComponent = verticalIconMap[vert.id] || TbBuildingCommunity;
