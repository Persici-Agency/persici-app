...
import type { TechStackPod } from '../data/public-sector.data';
import { TechInfrastructureCard } from '@shared';
import { sectionContainer } from '@shared/constants';
import { FadeUp } from '@shared';

interface PublicSectorTechStackSectionProps {
  pods: TechStackPod[];
  title: string;
  subtitle: string;
  lang: string;
...
export function PublicSectorTechStackSection({
  pods,
  title,
  subtitle,
  lang,
}: PublicSectorTechStackSectionProps) {
  const isRtl = lang === 'ar';
