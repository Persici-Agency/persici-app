...
import type { TechStackPod } from '../data/energy-commodities.data';
import { TechInfrastructureCard } from '@shared';
import { sectionContainer } from '@shared/constants';
import { FadeUp } from '@shared';

interface EnergyCommoditiesTechStackSectionProps {
  pods: TechStackPod[];
  title: string;
  subtitle: string;
  lang: string;
...
export function EnergyCommoditiesTechStackSection({
  pods,
  title,
  subtitle,
  lang,
}: EnergyCommoditiesTechStackSectionProps) {
  const isRtl = lang === 'ar';
