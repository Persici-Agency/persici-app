...
import type { EnergyCommoditiesVerticalItem } from '../data/energy-commodities.data';
...
interface EnergyCommoditiesVerticalsSectionProps {
...
const verticalIconMap: Record<string, React.ElementType> = {
  'power-utilities': TbBolt,
  'oil-gas': TbFlame,
  'commodity-agribusiness': TbCoins,
  'carbon-cleantech': TbLeaf,
};

export function EnergyCommoditiesVerticalsSection({
  verticals,
  title,
  subtitle,
  lang,
}: EnergyCommoditiesVerticalsSectionProps) {
  const isRtl = lang === 'ar';
      ...
      <div className={sectionContainer}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {verticals.map((vert, idx) => {
            ...
            const IconComponent = verticalIconMap[vert.id] || TbSolarPanel;
