...
import type { EnergyCommoditiesOfferingItem } from '../data/energy-commodities.data';
import { CapabilityCard } from '@shared';
import { sectionContainer } from '@shared/constants';
import { FadeUp } from '@shared';

interface EnergyCommoditiesOfferingsGridProps {
...
export function EnergyCommoditiesOfferingsGrid({
  offerings,
  title,
  subtitle,
  lang,
}: EnergyCommoditiesOfferingsGridProps) {
  const isRtl = lang === 'ar';
  ...
  return (
    <section id="offerings" className="py-20 sm:py-28 lg:py-32 bg-white relative scroll-mt-24">
      <div className={sectionContainer}>
        ...
        {/* Minimal Icon-Only Pause / Resume Button */}
