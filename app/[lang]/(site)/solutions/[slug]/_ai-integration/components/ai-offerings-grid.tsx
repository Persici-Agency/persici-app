...
export function AiOfferingsGrid({
  offerings,
  title,
  subtitle,
  lang,
}: AiOfferingsGridProps) {
  const isRtl = lang === 'ar';
  ...
  return (
    <section id="offerings" className="py-20 sm:py-28 lg:py-32 bg-white relative scroll-mt-24">
      <div className={sectionContainer}>
        ...
        {/* 6 Cards: Responsive 3-Column Grid with Centered Remainder */}
