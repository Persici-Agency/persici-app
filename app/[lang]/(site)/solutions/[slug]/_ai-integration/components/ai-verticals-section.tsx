...
interface AiVerticalsSectionProps {
...
const verticalIconMap: Record<string, React.ElementType> = {
  'banking-fintech': TbBuildingBank,
  'healthcare-diagnostics': TbHeartRateMonitor,
  'ecommerce-retail': TbShoppingBag,
  'supply-chain': TbTruck,
  'legal-governance': TbScale,
};

export function AiVerticalsSection({
  verticals,
  title,
  subtitle,
  lang,
}: AiVerticalsSectionProps) {
  const isRtl = lang === 'ar';
      ...
      <div className={sectionContainer}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
          {verticals.map((vert, idx) => {
            ...
            const IconComponent = verticalIconMap[vert.id] || TbCpu;
