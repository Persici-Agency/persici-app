...
interface DigitalEngineeringOfferingsGridProps {
...
export function DigitalEngineeringOfferingsGrid({
  offerings,
  title,
  subtitle,
  lang,
}: DigitalEngineeringOfferingsGridProps) {
  const isRtl = lang === 'ar';
      ...
      <div className={sectionContainer}>
        ...
        <FadeUp delay={0} duration={700} distance={20} className="text-center max-w-3xl mx-auto mb-14 sm:mb-20">
          <span className="text-xs sm:text-sm font-bold uppercase tracking-widest text-persici-crimson block mb-3">
            {isRtl ? 'القدرات الهندسية الأساسية' : 'Core Capabilities'}
          </span>
