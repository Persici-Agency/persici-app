...
import { TbLayersLinked, TbBrandAppgallery, TbChartDots3, TbShieldLock } from 'react-icons/tb';

interface CustomerEngagementTechStackSectionProps {
  pods: TechStackPod[];
  title: string;
  subtitle: string;
  lang: string;
...
export function CustomerEngagementTechStackSection({
  pods,
  title,
  subtitle,
  lang,
}: CustomerEngagementTechStackSectionProps) {
  const isRtl = lang === 'ar';
