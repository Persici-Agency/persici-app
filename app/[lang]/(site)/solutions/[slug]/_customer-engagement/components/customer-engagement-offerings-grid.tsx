...
import type { CustomerEngagementOfferingItem } from '../data/customer-engagement.data';
import { SolutionsCapabilityCard } from '../../../_solutions/components';
import { sectionContainer } from '@shared/constants';
import { FadeUp } from '@shared';

interface CustomerEngagementOfferingsGridProps {
...
export function CustomerEngagementOfferingsGrid({
  offerings,
  title,
  subtitle,
  lang,
}: CustomerEngagementOfferingsGridProps) {
  const isRtl = lang === 'ar';
