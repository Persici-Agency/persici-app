                ...
                <div className="group relative flex flex-col justify-between h-full p-7 sm:p-8 rounded-2xl sm:rounded-3xl bg-white border border-black/8 shadow-xs hover:shadow-xl hover:border-persici-crimson/30 transition-all duration-300">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <span className="font-mono text-[9.5px] uppercase tracking-wider font-semibold px-2.5 py-1 rounded-full bg-black/5 text-foreground/70">
                        {perk.tag[isAr ? 'ar' : 'en']}
                      </span>
                    </div>

                    <h3 className="font-primary text-lg sm:text-xl font-medium text-foreground mb-3 leading-snug group-hover:text-persici-crimson transition-colors">
