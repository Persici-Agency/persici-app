            ...
            {data.stats.map((stat, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="font-mono text-5xl sm:text-6xl lg:text-[68px] font-normal tracking-tight text-black leading-none mb-3 sm:mb-4 tabular-nums">
                    <CountUp
                      end={stat.number}
                      suffix={stat.suffix}
                  ...
                  <p className="font-secondary text-sm sm:text-[15px] text-slate-500 font-normal leading-normal">
                    {label}
                  </p>
                </FadeUp>
              );
