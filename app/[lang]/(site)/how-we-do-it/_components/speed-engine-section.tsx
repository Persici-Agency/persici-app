              ...
              >
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <span className="font-mono text-4xl sm:text-5xl font-black text-white/20 group-hover:text-persici-crimson transition-colors duration-300">
                      {pillar.letter}
                    </span>
                  ...
                  <h3 className="text-lg sm:text-xl font-primary font-bold text-white mb-3">
                    {pName}
                  </h3>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 flex items-center justify-between">
                  <span className="text-[11px] font-mono uppercase tracking-wider text-slate-400 group-hover:text-slate-200 transition-colors">
