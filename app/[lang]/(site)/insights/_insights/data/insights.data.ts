...
export const insightsData: InsightDetail[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: {
          ...
          ar: [
            'قد يثير الاستخدام غير المنضبط للذكاء الاصطناعي مخاوف مؤسسية تتعلق بحماية الملكية الفكرية، والمعلومات المهلوسة، والاعتماد المفرط. لتوفير بيئة ابتكار آمنة، وضعت بيرسيشي "ميثاق التسليم الإنساني المحكم".',
    ...
    sections: [
      {
        ...
        paragraphs: {
          ...
          ar: [
            ...
            'في بيرسيشي، نطبق مبدأ "كتلة جينز" على بناء المشاريع: فما لم يبلغ الفريق متعدد التخصصات الحد الحرج من التناغم الهندسي والتصميمي والتجاري، فإن التشتت المؤسسي سيقوض المبادرة حتماً.',
          ],
        },
      },
      {
  ...
  },
  {
    ...
    excerpt: {
      ...
      ar: 'تفاصيل مشوقة من كواليس إعادة هيكلة نموذج عمل بيرسيشي للقضاء على الهدر الإعلاني وتحقيق نمو مركب ومستدام لشركائنا.',
    },
    readTime: '6 min read',
    date: 'July 09, 2024',
    coverImage: '/images/insights/data-into-value-office.jpg',
    ...
    sections: [
      {
        ...
        paragraphs: {
          ...
          ar: [
            ...
            'استبدلت بيرسيشي هذا الهيكل المترهل بفِرق عمل مشتركة ومرنة؛ حيث يعمل مخطط الحملات بجوار مخرج الفيديو مباشرة، ويقومان بتعديل المواد الإعلانية الأكثر جذباً في الوقت الفعلي.',
          ],
        },
      },
      {
