...
export function ContactHeroSection({ data, lang }: ContactHeroSectionProps) {
  ...
  return (
    <section data-header-luminance="light" dir={isAr ? 'rtl' : 'ltr'} className="relative pt-24 sm:pt-28 lg:pt-32 pb-14 sm:pb-16 lg:pb-20 bg-gradient-to-b from-slate-50 via-white to-white overflow-hidden border-b border-black/[0.04]">
      ...
      <div className={sectionContainer}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <FadeUp delay={0} duration={600} distance={16}>
            <span className={`${badgePill} mb-4 tracking-wide uppercase text-[9.5px] font-mono font-semibold rtl:tracking-normal rtl:normal-case rtl:font-primary`}>
              {badge}
            </span>
          </FadeUp>
          ...
          <FadeUp delay={100} duration={750} distance={20}>
            <h1 className="font-primary text-3xl sm:text-5xl lg:text-6xl font-medium tracking-tight rtl:tracking-normal text-persici-black leading-[1.12] rtl:leading-[1.25] rtl:sm:leading-[1.2] mb-6">
              {title}
            </h1>
          </FadeUp>
