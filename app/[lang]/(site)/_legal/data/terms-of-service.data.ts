...
export const termsOfServiceData: LegalDocumentData = {
  ...
  subtitle: {
    ...
    ar: 'الشروط التجارية العامة، وأطر الملكية الفكرية، والالتزامات النظامية متعددة النطاقات القضائية، والقواعد الحاكمة لتعاملات العملاء مع وكالة بيرسيشي.',
  },
  effectiveDate: {
    en: 'January 15, 2026',
    ar: '١٥ يناير ٢٠٢٦',
  ...
  clauses: [
    {
      ...
      content: {
        ...
        ar: [
          'تشكل شروط الخدمة هذه ("الشروط") اتفاقية ملزمة قانوناً بين وكالة بيرسيشي ("بيرسيشي"، "نحن"، أو "خاصتنا") وأي مؤسسة أو شركة أو فرد ("العميل" أو "أنتم") يدخل إلى منصاتنا أو يتعاقد على خدماتنا المهنية.',
    ...
    },
    {
      ...
      content: {
        ...
        ar: [
          'تقدم بيرسيشي خدمات تقنية واستراتيجية متقدمة في تسريع التجارة الإلكترونية، والتسويق الرقمي الشامل، والهندسة السحابية، وتصميم النظم الرقمية (UX/UI)، وحوكمة البيانات المؤسسية.',
    ...
    },
    {
      ...
      content: {
        ...
        ar: [
          ...
          '• الملكية الفكرية المسبقة للوكالة (Background IP): تحتفظ بيرسيشي بملكيتها الحصرية للمكتبات البرمجية، والمكونات المسبقة، والخوارزميات، والأدوات المطورة بشكل مستقل عن المشروع. وتمنح العميل ترخيصاً دائماً وغير حصري وعالمياً لاستخدامها كجزء مدمج في النظام المسلم.',
          '• مواد وبيانات العميل: يضمن العميل ملكيته الكاملة أو امتلاكه التراخيص النظامية لكافة العلامات التجارية والبيانات والمواد التي يزود بها بيرسيشي لتنفيذ المشروع.',
        ],
      },
    },
    {
    ...
    },
    {
      ...
      content: {
        ...
        ar: [
          '• العناية المهنية الواجبة: تضمن بيرسيشي تنفيذ كافة المخرجات البرمجية والتصميمية بأعلى معايير الحرفية ومطابقة أفضل ممارسات هندسة البرمجيات الحديثة.',
          ...
          '• استثناءات الطرف الثالث: لا تتحمل بيرسيشي مسؤولية انقطاع أو تغيير بروتوكولات واجهات الطرف الثالث السحابية مثل Shopify أو Google أو Meta أو بوابات الدفع الإلكتروني.',
        ],
      },
    },
    {
    ...
    },
    {
      ...
      content: {
        ...
        ar: [
          ...
          '• تنحصر المسؤولية المالية الإجمالية القصوى لبيرسيشي عن أي مطالبة ناشئة عن نطاق العمل في حدود إجمالي المبالغ المسددة فعلياً من العميل بموجب ذلك النطاق خلال الستة (6) أشهر السابقة لوقوع الحدث.',
        ],
      },
    },
    {
      ...
      content: {
        ...
        ar: [
          'يتحدد القانون الحاكم والجهة القضائية المختصة بالنزاعات وفق الكيان التعاقدي لبيرسيشي المحدد في نطاق العمل (SOW):',
    ...
    },
    {
      ...
      content: {
        ...
        ar: [
          ...
          '• تسليم الأعمال المنجزة: عند الإنهاء، تسلم بيرسيشي كافة المخرجات المعتمدة والمدفوعة بالكامل مع بيانات الوصول للمستودعات البرمجية والتوثيق اللازم.',
